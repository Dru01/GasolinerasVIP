...
namespace GasolinerasVIP.API.Migrations
{
    ...
    [Migration("20230608214101_users_refresh_token")]
    partial class users_refresh_token
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GasolinerasVIP.API.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("GasolinerasVIP.API.Models.GasStation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GasolinerasVIP.API.Models.Transaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GasolinerasVIP.API.Models.UserRefreshToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GasolinerasVIP.API.Models.Transaction", b =>
                {
                    b.HasOne("GasolinerasVIP.API.Models.GasStation", "GasStation")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("GasolinerasVIP.API.Models.ApplicationUser", null)
                        .WithMany()
